  ...
  <body>
	...
	?>
	  ...
	  <p><?php
		...
		$sql = 'SELECT screen_id, image, answer0, validated, cat_name FROM screentest.Question INNER JOIN screentest.Category ON screentest.Question.cat_id=screentest.Category.cat_id ORDER BY screen_id ASC';
		foreach ($connec->query($sql) as $row) {
